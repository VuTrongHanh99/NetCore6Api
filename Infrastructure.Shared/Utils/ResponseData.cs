...
namespace NetCore.Shared
{
    ...
    {
        public ResponseUpdate(int id)
        {
            Data = new ResponseUpdateModel { Id = id };
        }

        public ResponseUpdate(int id, string message) : base(message)
        {
            Data = new ResponseUpdateModel { Id = id };
        }

        public ResponseUpdate(Code code, string message, int id) : base(code, message)
        {
            Data = new ResponseUpdateModel { Id = id };
        }
    ...
    {
        public ResponseDelete(int id, string name)
        {
            Data = new ResponseDeleteModel { Id = id, Name = name };
        }

        public ResponseDelete(Code code, string message, int id, string name) : base(code, message)
        {
            Data = new ResponseDeleteModel { Id = id, Name = name };
        }
    ...
    public class ResponeUpdateItemsModel
    {
        public int Id { get; set; }
        public string Name { get; set; }
        public bool Result { get; set; }
